...
Campaigns are automated messaging workflows that send push notifications to your users based on triggers. Flare supports multiple trigger types to cover different use cases.
...
A campaign in Flare has the following structure:
...
Flare supports four types of campaign triggers:
