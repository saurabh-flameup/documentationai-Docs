---
title: Rate Limits
description: Understanding Flare API rate limits and quotas
---

## Overview

Flare implements rate limiting to ensure fair usage and platform stability. Rate limits are applied per API key and vary by endpoint type.
